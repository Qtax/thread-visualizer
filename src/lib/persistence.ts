 ...
 */
export const GETTING_STARTED_TEMPLATE_DATE = "2026-05-08T10:00:00Z";
	...
	return [
		{
			...
			code: [
				...
				"Use skip for code that does not run in this path. [sync tags-ignored] [skip]",
				"",
				...
				"shutdown()",
				"",
				"mark across all threads with [hr]",
				"",
				"[sync error-handling]",
				"",
				"### detects cycles",
